...
<details>
<summary><strong>Full feature list (71 MCP tools)</strong></summary>
...
Every command and all 71 MCP tools, organized as user journeys, plus
...
| **MCP** | All 71 tools via MCP protocol, no shell hooks | Protocol-only agents (JetBrains, VS Code, Zed, ...) |
...
- **71 MCP tools** — from simple file reads to multi-agent orchestration
