...
For agents without direct shell access. All 71 tools available via MCP protocol.
...
Every agent gets access to the same 71 MCP tools. The most important ones:
